...
//////////////////////////////////
	...
	//////////////////////////////////
		...
		//
		struct PW_INTERNAL_DATA_API ID_DOWN_RS_Triangle {
		...
		public:
			...
			//  color information.
			//
			static PW_VOID Handle_Model_Data_C(PW_SRD_PTR(Mesh)& model_mesh, glm::vec4 model_color);
		// Public Variables        
		public:
		...
		//  Picture of triangle(X = blank) (o = triangle)
		//
		struct PW_INTERNAL_DATA_API ID_DOWN_LS_Triangle {
		// Default Class Structures 
		public:
		private:
		// Public Functions/Macros 
		...
		//	Picture of triangle(X = blank) (o = triangle)
		//
		struct PW_INTERNAL_DATA_API ID_UP_RS_Triangle {
		// Default Class Structures
		public:
		private:
		// Public Functions/Macros 
		...
		//	Picture of triangle(X = blank) (o = triangle)
		//
		struct PW_INTERNAL_DATA_API ID_UP_LS_Triangle {
		// Default Class Structures 
		public:
		private:
		// Public Functions/Macros 
		...
		//
		struct PW_INTERNAL_DATA_API ID_Square {
		// Default Class Structures 
		public:
		private:
		// Public Functions/Macros 
		...
		//	Picture of square(x = blank) (o = square)
		//
		struct PW_INTERNAL_DATA_API ID_HAFE_RS_Square {
		// Default Class Structures 
		public:
		private:
		// Public Functions/Macros  
		...
		//	Picture of square(x = blank) (o = square)
		//
		struct PW_INTERNAL_DATA_API ID_HAFE_LS_Square {
		// Default Class Structures 
		public:
		private:
		// Public Functions/Macros  
		...
		//	Picture of square(x = blank) (o = square)
		//
		struct PW_INTERNAL_DATA_API ID_HAFE_UP_Square {
		// Default Class Structures
		public:
		private:
		// Public Functions/Macros  
		...
		//	Picture of square(x = blank) (o = square)
		//
		struct PW_INTERNAL_DATA_API ID_HAFE_DOWN_Square {
		// Default Class Structures 
		public:
		private:
		// Public Functions/Macros  
		...
		//////////////////////////////////
		// Class Name: pw::ie::Model
		//																				 
		// Purpose: A structure that ties static model's and dynamic models together.
		//
		class PW_INTERNAL_API Model {
			// Default Class Structures 
		public:
		private:
			// Public Functions/Macros  
		public:
			// Public Variables
			static PW_LLUINT model_counter;
			static PW_LLUINT model_id_assigner;
		public:
			// Private Functions/Macros 
		private:
			// Private Variables        
		...
		class PW_INTERNAL_API Dynamic_Model;
		//////////////////////////////////
		...
		//
		class PW_INTERNAL_API Static_Model : public Model {
		// Default Class Structures 
		public:
			...
			//  Variation: NO-COLOR 
			//
			Static_Model(Mesh_Types type, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size);
			// Function: Static_Model::Static_Model
			//
			// Purpose: Creates a colored static model that only
			//  updates once it is created. May be updated on resize.
			//
			Static_Model(Mesh_Types type, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size, glm::vec4 model_color);
			// Function: Static_Model::Static_Model
			//
			// Purpose: Creates a full static model, only
			//  updates once it is created and nevermore until
			...
			//  Variation: NO-COLOR 
			//
			Static_Model(Mesh_Types type, ID_Vertex_Data* mesh_info, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size);
			// Function: Static_Model::Static_Model
			//
			// Purpose: Creates a colored static model that only
			//  updates once it is created. May be updated on resize.
			//
			Static_Model(Mesh_Types type, ID_Vertex_Data* mesh_info, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size, glm::vec4 model_color);
			// Function: Static_Model::~Static_Model
			//
		...
		// Public Variables         
		public:
			static PW_VOID(*model_functions_noc[(PW_INT)Mesh_Types::TYPE_COUNT - 1])(PW_SRD_PTR(Mesh)& model_mesh);
			static PW_VOID(*model_functions_c[(PW_INT)Mesh_Types::TYPE_COUNT - 1])(PW_SRD_PTR(Mesh)& model_mesh, glm::vec4 model_color);

			static ID_Vertex_Data* model_vertices[(PW_INT)Mesh_Types::TYPE_COUNT - 1];
			static const PW_SUINT model_vertices_count[(PW_INT)Mesh_Types::TYPE_COUNT - 1];
		...
		//
		class PW_INTERNAL_API Dynamic_Model : public Model {
		// Default Class Structures 
		public:
			...
			//  every frame.
			//
			Dynamic_Model(Mesh_Types type, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size);
			// Function: Dynamic_Model::Dynamic_Model
			//
			// Purpose: Creates a colored dynamic model. Updates
			//  every frame.
			//
			Dynamic_Model(Mesh_Types type, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size, glm::vec4 model_color);
			// Function: Dynamic_Model::Dynamic_Model
			//
			// Purpose: Creates a un-colored dynamic model. Updated
			//  every frame.
			//
			Dynamic_Model(Mesh_Types type, ID_Vertex_Data* mesh_info, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size);
			// Function: Dynamic_Model::Dynamic_Model
			//
			// Purpose: Creates a colored dynamic model. Updates
			//  every frame.
			//
			Dynamic_Model(Mesh_Types type, ID_Vertex_Data* mesh_info, Texture* texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size, glm::vec4 model_color);
			// Function: Dynamic_Model::~Dynamic_Model
			//
		...
		public:
			...
			//
			PW_VOID Set_Model_Color(glm::vec4 new_model_color);
