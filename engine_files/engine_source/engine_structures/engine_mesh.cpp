...
//////////////////////////////////
	...
	//////////////////////////////////
		...
		// Class Members
			...
			glm::vec4 ID_Vertex_Data::Color_Data() {
		...
		// Class Members           
			...
			Mesh::Mesh(ID_Vertex_Data* vertices, const PW_SUINT vertex_count, PW_UINT* indices, const PW_SUINT indice_count) :
				...
				this->vertices = std::make_shared<ID_Vertex_Data*>(new ID_Vertex_Data[vertex_count]);
				...
				PW_SRD_PTR(glm::vec3*) vertex_position_arr =
					std::make_shared<glm::vec3*>(new glm::vec3[vertex_count]);
				PW_SRD_PTR(glm::vec2*) texture_data_arr =
					std::make_shared<glm::vec2*>(new glm::vec2[vertex_count]);
				PW_SRD_PTR(glm::vec4*) color_data =
					std::make_shared<glm::vec4*>(new glm::vec4[vertex_count]);
