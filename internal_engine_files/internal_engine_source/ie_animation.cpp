...
namespace pw {
	namespace ie {
		...
		/* Static Declarations      */
		/* Class Members            */
		Animation::Animation(PW_FLOAT animation_length, PW_UINT frame_count, PW_UINT frame_size_x, ID_Vertex_Data* vertices_default, PW_SIZE vertices_count, ID_Vertex_Data*& vertices) :
		...
		ID_Vertex_Data* Animation::Change_Frame() {
