...
//////////////////////////////////
	...
	//////////////////////////////////
		...
		// Class Members
			...
			PW_VOID ID_DOWN_RS_Triangle::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_DOWN_RS_Triangle::Vertices(),
						ID_DOWN_RS_Triangle::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_DOWN_LS_Triangle::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_DOWN_LS_Triangle::Vertices(),
						ID_DOWN_LS_Triangle::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_UP_RS_Triangle::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_UP_RS_Triangle::Vertices(),
						ID_UP_RS_Triangle::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_UP_LS_Triangle::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_UP_LS_Triangle::Vertices(),
						ID_UP_LS_Triangle::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_Square::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_Square::Vertices(),
						ID_Square::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_HAFE_RS_Square::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_HAFE_RS_Square::Vertices(),
						ID_HAFE_RS_Square::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_HAFE_LS_Square::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_HAFE_LS_Square::Vertices(),
						ID_HAFE_LS_Square::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_HAFE_UP_Square::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_HAFE_UP_Square::Vertices(),
						ID_HAFE_UP_Square::Vertices_Size(),
		...
		// Class Members
			...
			PW_VOID ID_HAFE_DOWN_Square::Handle_Model_Data_C(std::shared_ptr<Mesh>& model_mesh, glm::vec3 model_color) {
				if (model_mesh == nullptr) {
					model_mesh = PW_SRD_PTR(Mesh)( new Mesh(
						ID_HAFE_DOWN_Square::Vertices(),
						ID_HAFE_DOWN_Square::Vertices_Size(),
		...
		// IE_Static_Model          
		// Static Declarations      
			PW_VOID(*Static_Model::model_functions_noc[(PW_INT)Model_Types::TYPE_COUNT - 1])(PW_SRD_PTR(Mesh)& model_mesh) {
			...
			PW_VOID(*Static_Model::model_functions_c[(PW_INT)Model_Types::TYPE_COUNT - 1])(PW_SRD_PTR(Mesh)& model_mesh, glm::vec3 model_color) {
		...
		// Class Members            
			Static_Model::Static_Model() :
					...
					model_mesh(nullptr), model_type(Model_Types::UNINIT), model_is_colored(false), model_color(NULL),
					model_matrix(0.0f) {
			}
			...
			Model_Types Static_Model::Model_Type() {
				return model_type;
			}
		...
		// IE_Dynamic_Model         
		// Static Declarations      
			PW_VOID(*Dynamic_Model::model_functions_noc[(PW_INT)Model_Types::TYPE_COUNT - 1])(PW_SRD_PTR(Mesh)& model_mesh) {
					ID_DOWN_RS_Triangle::Handle_Model_Data_NOC,
					ID_DOWN_LS_Triangle::Handle_Model_Data_NOC,
					ID_UP_RS_Triangle::Handle_Model_Data_NOC,
					ID_UP_LS_Triangle::Handle_Model_Data_NOC,
			...
			PW_VOID(*Dynamic_Model::model_functions_c[(PW_INT)Model_Types::TYPE_COUNT - 1])(PW_SRD_PTR(Mesh)& model_mesh, glm::vec3 model_color) {
					ID_DOWN_RS_Triangle::Handle_Model_Data_C,
					ID_DOWN_LS_Triangle::Handle_Model_Data_C,
					ID_UP_RS_Triangle::Handle_Model_Data_C,
					ID_UP_LS_Triangle::Handle_Model_Data_C,
		...
		// Class Members            
			Dynamic_Model::Dynamic_Model() :
					...
					model_size(NULL), model_mesh(nullptr), model_type(Model_Types::UNINIT), model_is_colored(false),
					model_color(NULL), last_body_pos(0.0f), model_matrix(0.0f) {
			}
			Dynamic_Model::Dynamic_Model(Model_Types type, Texture texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size) :
					...
					model_color(glm::vec3(0.0f, 0.0f, 0.0f)), last_body_pos(0.0f), model_matrix(0.0f) {
				if (model_type != Model_Types::UNINIT) {
					model_functions_noc[(int)model_type - 1](this->model_mesh);
				}
			}
			Dynamic_Model::Dynamic_Model(Model_Types type, Texture texture, glm::vec2 model_position, PW_FLOAT model_rotation, glm::vec2 model_size, glm::vec3 model_color) :
					...
					model_color(model_color), last_body_pos(0.0f), model_matrix(0.0f) {
				model_functions_c[(int)model_type - 1](this->model_mesh, this->model_color);
			}
			...
			Model_Types Dynamic_Model::Model_Type() {
				return model_type;
			}
